...
FILE *filer, *filew;
int numr, numw;
char buffer[2352]; // 1 settore come in CD-ROM
...
if(bCopyError)
{
cellFsUnlink(gamePKG->szFileOut); // cancella file
...
"[Errore] Impossibile creare la directory desiderata sul disco rigido.",
...
::cellMsgDialogOpen2(
CELL_MSGDIALOG_DIALOG_TYPE_NORMAL,
"[Errore] Impossibile creare / scrivere file necessari per HDD.",
callbackfunction, NULL, NULL
);
pkglst[nSelectedPKG]->bQueued = false;
return 0;
